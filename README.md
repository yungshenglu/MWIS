...
Simulates the mailbox operation, let each vertex to have own send buffer and reveived buffer to pass the own information to it's neightbors.
...
* Calculate the MWIS set in several runs.
    ...
    * In Each run, there are two sub-run in it.
...
> This repository is NCTU CS course assignments of "Distributed Algorithnm". If you are taking this course, please do not duplicate from this repository. All rights reserved.
